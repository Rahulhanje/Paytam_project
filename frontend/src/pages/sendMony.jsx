                ...
                <div class="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                    ...
                    <div className="p-6">
                        <div className="flex  items-center space-x-4">
                            <div className="flex justify-center bg-green-500 w-12 h-12 rounded-full">
                                <div className="flex item-center font-bold justify-center">
                                    <span className="text-3xl pt-1">A</span>
                                </div>
                            </div>
                        ...
                        <div >
                            ...
                            <div className="pt-5"><button class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">
                                Initiate Transfer
                            </button></div>
                        </div>
                    </div>
